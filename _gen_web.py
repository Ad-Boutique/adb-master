...
WEBCASES = [
 dict(slug="case-web-noma", key="noma", name="Noma Wien", url="https://www.noma.wien",
  ...
  line="13 von 26 verkauft. In wenigen Monaten.",
  ...
  kap=dict(label="Zweites Kapitel, die Vermarktung",
           ...
           p2="<b>In den ersten elf Wochen kamen rund 70 Anfragen von 35 Interessenten über die Website, darunter sieben Anleger.</b> Ein halbes Jahr nach Go-live sind 13 der 26 Wohnungen verkauft. Dazwischen lag die unangenehmste Erkenntnis des Projekts: Die Seite lud am Telefon in 16 Sekunden. Der größte Conversion-Hebel war kein neues Sujet, sondern Ladezeit.",
 ...
 dict(slug="case-web-trattner", key="trattner", name="Trattner & Söhne", url="https://www.trattner-soehne.at",
  ...
  line="So souverän wie im persönlichen Gespräch.",
 ...
 dict(slug="case-web-unio", key="unio", name="UNIO", url="https://www.unio.at",
  ...
  line="Real Estate, endlich einfach.",
 ...
 dict(slug="case-web-havenstone", key="havenstone", name="Havenstone", url="https://www.havenstone.at",
  ...
  line="Größe zeigen, ohne laut zu werden.",
 ...
 dict(slug="case-web-northpoint", key="northpoint", name="Northpoint Advisors", url="https://northpoint-advisors.com",
  ...
  line="Vertrauen, in zwei Sprachen erzählt.",
 ...
 dict(slug="case-web-pharmacom", key="pharmacom", name="Pharmacom", url="https://www.pharmacom.at",
  branche="Pharma, B2B",
  line="Ein B2B-Modell, das man versteht.",
 ...
 dict(slug="case-web-daphi", key="daphi", name="DaPhi", url="https://www.daphi.de",
  ...
  line="Vom Kick-off zum Go-live in zwölf Wochen.",
 ...
 dict(slug="case-web-ib7", key="ib7", name="IB-7", url="https://ib-7.com",
  ...
  leistungen="Website & Markenauftritt<br>Social Media & Content<br>Grafik & Anzeigen<br>Performance Marketing",
  ...
  kap=dict(label="Zweites bis viertes Kapitel",
           h="Marke, Social Media, Grafik, Kampagnen. Aus einer Hand.",
           p1="Neben der Website betreuen wir die Marke dort, wo sie täglich stattfindet: Social Media mit Feed und Stories, Grafik für Anzeigen, Sampling-Karten und Beiträge, Produktfotografie und Bewegtbild, dazu die Performance-Kampagnen auf Meta und Google, die den Shop und den Direktvertrieb an Studios und Parfümerien tragen. Was schon steht: eine Website mit Hero-Film, ein Founder-Reel, UGC-Anzeigen und ein Sampling-Formular für den Vertrieb.",
           p2="<b>Ergebnisse zeigen wir hier noch nicht.</b> Die Kampagnen sind gerade erst gestartet, und wir berichten Zahlen, wenn sie belastbar sind, nicht wenn sie gut aussehen. Wer die Seite baut, sitzt auch im Call, in dem die ersten Zahlen gelesen werden: Marke, Website, Content und Performance folgen so einer Linie, statt an drei Agenturen zu hängen.",
           links=[("service-content-creation.html", "Content Creation"), ("service-performance-marketing.html", "Performance Marketing")]),
 ...
 dict(slug="case-web-twistnsparkle", key="twistnsparkle", name="Twist'n Sparkle, isi", url="https://www.twistnsparkle.isi.com/en",
  ...
  line="Ein Produkt. Ein Versprechen. Eine Seite.",
